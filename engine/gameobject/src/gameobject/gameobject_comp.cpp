...
namespace dmGameObject
{
    Result RegisterComponentTypes(dmResource::HFactory factory, HRegister regist, dmScript::HContext script_context)
    {
        ...
        script_component.m_UpdateOrderPrio = 200;  // Modified by dotGears / TheTrung : from 200 -> 250
        ...
        anim_component.m_UpdateOrderPrio     = 250; // Modified by dotGears / TheTrung : from 250 -> 300
