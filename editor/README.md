...
- Local editor sources, archived engine artifacts based on HEAD:
  - `./scripts/bundle.py bundle --platform=x86_64-win32 --version=1.2.3.4 --engine-artifacts=archived`
...
- Local editor sources, archived engine artifacts based on a different revision:
  - `./scripts/bundle.py bundle --platform=x86_64-win32 --version=1.2.3.4 --engine-artifacts=archived-stable`
...
- Local editor sources, local engine artifacts, local launcher:
  - `./scripts/bundle.py bundle --platform=x86_64-win32 --version=1.2.3.4 --engine-artifacts=dynamo-home`
...
- Local editor sources, archived engine artifacts, local launcher:
  - `./scripts/bundle.py bundle --platform=x86_64-win32 --version=1.2.3.4  --engine-artifacts=archived --launcher ../tmp/dynamo_home/bin/x86_64-darwin/launcher`
